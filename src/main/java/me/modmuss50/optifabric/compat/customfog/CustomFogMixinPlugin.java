package me.modmuss50.optifabric.compat.customfog;
...
public class CustomFogMixinPlugin extends InterceptingMixinPlugin {
	@Override
		...
		if ("BackgroundRendererMixin".equals(mixinInfo.getName())) {
			...
			for (MethodNode method : targetClass.methods) {
				if (applyFog.equals(method.name)) {
					...
					extra.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/mojang/blaze3d/systems/RenderSystem", "setupNvFogDistance", "()V", false));
					extra.add(skip);
